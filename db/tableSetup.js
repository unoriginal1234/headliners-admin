...
const insertQuery1 = {
  text: `INSERT INTO gamecard (id, Venue, Headliner, Openers, isPlaying, hasPlayed) VALUES (1, $1, $2, $3, true, false)`,
...
client.connect()
  ...
  .then(()=> client.query('CREATE TABLE IF NOT EXISTS gamecard (id SERIAL NOT NULL PRIMARY KEY, venue jsonb, headliner jsonb, openers jsonb[], isplaying boolean, hasplayed boolean)'))
